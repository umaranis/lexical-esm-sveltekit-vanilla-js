...
gb={bold:1,code:16,highlight:128,italic:2,strikethrough:4,subscript:32,superscript:64,underline:8},kb={directionless:1,unmergeable:2},lb={center:2,end:6,justify:4,left:1,right:3,start:5},mb={2:"center",6:"end",4:"justify",1:"left",3:"right",5:"start"},nb={normal:0,segmented:2,token:1},ob={0:"normal",2:"segmented",1:"token"};function pb(...a){let b=[];for(let c of a)if(c&&"string"===typeof c)for(let [d]of c.matchAll(/\S+/g))b.push(d);return b}let qb=!1,rb=0;
function sb(a){rb=a.timeStamp}function tb(a,b,c){return b.__lexicalLineBreak===a||void 0!==a[`__lexicalKey_${c._key}`]}function ub(a){return a.getEditorState().read(()=>{let b=u();return null!==b?b.clone():null})}
...
function Xb(a){for(;null!=a;){if(3===a.nodeType)return a;a=a.firstChild}return null}function Yb(a,b,c){let d=gb[b];if(null!==c&&(a&d)===(c&d))return a;a^=d;"subscript"===b?a&=~gb.superscript:"superscript"===b&&(a&=~gb.subscript);return a}function Zb(a,b){if(null!=b)a.__key=b;else{G();99<$b&&n(14);b=F();var c=ac(),d=""+Kb++;c._nodeMap.set(d,a);E(a)?b._dirtyElements.set(d,!0):b._dirtyLeaves.add(d);b._cloneNotNeeded.add(d);b._dirtyType=1;a.__key=d}}
...
function mc(a,b,c){b=xb(b._window);if(null!==b){var d=b.anchorNode,{anchorOffset:e,focusOffset:f}=b;if(null!==d&&(b=3===d.nodeType?d.nodeValue:null,d=wb(d),null!==b&&B(d))){if(b===cb&&c){let g=c.length;b=c;f=e=g}null!==b&&yb(d,b,e,f,a)}}}
function yb(a,b,c,d,e){let f=a;if(f.isAttached()&&(e||!f.isDirty())){let m=f.isComposing(),q=b;(m||e)&&b[b.length-1]===cb&&(q=b.slice(0,-1));b=f.getTextContent();if(e||q!==b)if(""===q)if(H(null),Ya||Za||bb)f.remove();else{let p=F();setTimeout(()=>{p.update(()=>{f.isAttached()&&f.remove()})},20)}else{e=f.getParent();b=nc();var g=f.getTextContentSize(),h=dc(),k=f.getKey();f.isToken()||null!==h&&k===h&&!m||C(b)&&(null!==e&&!e.canInsertTextBefore()&&0===b.anchor.offset||b.anchor.key===a.__key&&0===b.anchor.offset&&
...
function pc(a,b){void 0===a.__lexicalClassNameCache&&(a.__lexicalClassNameCache={});let c=a.__lexicalClassNameCache,d=c[b];if(void 0!==d)return d;a=a[b];return"string"===typeof a?(a=pb(a),c[b]=a):a}function qc(a,b,c,d,e){0!==c.size&&(c=d.__type,d=d.__key,b=b.get(c),void 0===b&&n(33,c),c=b.klass,b=a.get(c),void 0===b&&(b=new Map,a.set(c,b)),a=b.get(d),c="destroyed"===a&&"created"===e,(void 0===a||c)&&b.set(d,c?"updated":e))}
...
function nd(a,b){var c=b.__lexicalDir;if(b.__lexicalDirTextContent!==N||c!==Pc){let f=""===N;if(f)var d=Pc;else d=N,d=eb.test(d)?"rtl":fb.test(d)?"ltr":null;if(d!==c){let g=b.classList,h=Kc.theme;var e=null!==c?h[c]:void 0;let k=null!==d?h[d]:void 0;void 0!==e&&("string"===typeof e&&(e=pb(e),e=h[c]=e),g.remove(...e));null===d||f&&"ltr"===d?b.removeAttribute("dir"):(void 0!==k&&("string"===typeof k&&(c=pb(k),k=h[d]=c),void 0!==k&&g.add(...k)),b.dir=d);Nc||(a.getWritable().__dir=d)}Pc=d;b.__lexicalDirTextContent=
N;b.__lexicalDir=d}}function gd(a,b){let c=[];for(a=a.__first;null!==a;){let d=b.get(a);void 0===d&&n(101);c.push(a);a=d.__next}return c}
function rd(a,b){var c=ad.get(a),d=bd.get(a);void 0!==c&&void 0!==d||n(61);var e=Mc||$c.has(a)||Qc.has(a);let f=uc(O,a);if(c===d&&!e)return E(c)?(d=f.__lexicalTextContent,void 0!==d&&(M+=d,Jc+=d),d=f.__lexicalDirTextContent,void 0!==d&&(N+=d)):(d=c.getTextContent(),B(c)&&!c.isDirectionless()&&(N+=d),Jc+=d,M+=d),f;c!==d&&e&&qc(dd,Lc,Oc,d,"updated");if(d.updateDOM(c,f,Kc))return d=ld(a,null,null),null===b&&n(62),b.replaceChild(d,f),ed(a,null),d;if(E(c)&&E(d)){a=d.__indent;a!==c.__indent&&jd(f,a);a=
...
let td=Object.freeze({}),Ad=[["keydown",ud],["pointerdown",vd],["compositionstart",wd],["compositionend",xd],["input",yd],["click",zd],["cut",td],["copy",td],["dragstart",td],["dragover",td],["dragend",td],["paste",td],["focus",td],["blur",td],["drop",td]];Xa&&Ad.push(["beforeinput",(a,b)=>Bd(a,b)]);let Cd=0,Dd=0,Ed=0,Fd=null,Gd=new WeakMap,Hd=!1,Id=!1,Jd=!1,Kd=!1,Ld=[0,"",0,"root",0];
...
function Bd(a,b){let c=a.inputType,d=Qd(a);"deleteCompositionText"===c||Wa&&Bb(b)||"insertCompositionText"!==c&&v(b,()=>{let e=u();if("deleteContentBackward"===c){if(null===e){var f=nc();if(!C(f))return;Ab(f.clone())}if(C(e)){$a&&H(e.anchor.key);229===Dd&&a.timeStamp<Cd+30&&b.isComposing()&&e.anchor.key===e.focus.key?(H(null),Cd=0,setTimeout(()=>{v(b,()=>{H(null)})},30),C(e)&&(f=e.anchor.getNode(),f.markDirty(),e.format=f.getFormat(),B(f)||n(142),e.style=f.getStyle()),1>=e.anchor.getNode().getTextContent().length&&
(a.preventDefault(),R(b,da,!0))):(H(null),a.preventDefault(),R(b,da,!0));return}}if(C(e)){f=a.data;null!==Fd&&mc(!1,b,Fd);e.dirty&&null===Fd||!e.isCollapsed()||L(e.anchor.getNode())||null===d||e.applyDOMRange(d);Fd=null;var g=e.focus,h=e.anchor.getNode();g=g.getNode();if("insertText"===c||"insertTranspose"===c)"\n"===f?(a.preventDefault(),R(b,ea,!1)):"\n\n"===f?(a.preventDefault(),R(b,fa,void 0)):null==f&&a.dataTransfer?(f=a.dataTransfer.getData("text/plain"),a.preventDefault(),e.insertRawText(f)):
null!=f&&Md(e,d,f,a.timeStamp,!0)?(a.preventDefault(),R(b,ka,f)):Fd=f,Ed=a.timeStamp;else switch(a.preventDefault(),c){case "insertFromYank":case "insertFromDrop":case "insertReplacementText":R(b,ka,a);break;case "insertFromComposition":H(null);R(b,ka,a);break;case "insertLineBreak":H(null);R(b,ea,!1);break;case "insertParagraph":H(null);Jd&&!Za?(Jd=!1,R(b,ea,!1)):R(b,fa,void 0);break;case "insertFromPaste":case "insertFromPasteAsQuotation":R(b,la,a);break;case "deleteByComposition":Rd(h,g)&&R(b,
...
d);Ya||Za||bb||!b.isComposing()||(Cd=0,H(null))}else mc(!1,b,null!==d?d:void 0),Kd&&(Sd(b,d||void 0),Kd=!1);G();c=F();Cb(c)});Fd=null}function wd(a,b){v(b,()=>{let c=u();if(C(c)&&!b.isComposing()){let d=c.anchor,e=c.anchor.getNode();H(d.key);(a.timeStamp<Cd+30||"element"===d.type||!c.isCollapsed()||e.getFormat()!==c.format||B(e)&&e.getStyle()!==c.style)&&R(b,ka,db)}})}
...
function Xd(a,b){var c=a.ownerDocument,d=Gd.get(c);void 0===d&&c.addEventListener("selectionchange",Wd);Gd.set(c,d||1);a.__lexicalEditor=b;c=Ud(a);for(d=0;d<Ad.length;d++){let [e,f]=Ad[d],g="function"===typeof f?h=>{!0!==h._lexicalHandled&&(h._lexicalHandled=!0,b.isEditable()&&f(h,b))}:h=>{if(!0!==h._lexicalHandled&&(h._lexicalHandled=!0,b.isEditable()))switch(e){case "cut":return R(b,Oa,h);case "copy":return R(b,Na,h);case "paste":return R(b,la,h);case "dragstart":return R(b,Ka,h);case "dragover":return R(b,
La,h);case "dragend":return R(b,Ma,h);case "focus":return R(b,Qa,h);case "blur":return R(b,Ra,h);case "drop":return R(b,Ja,h)}};a.addEventListener(e,g);c.push(()=>{a.removeEventListener(e,g)})}}
...
function ke(a,b,c,d,e){a=d.classList;d=pc(e,"base");void 0!==d&&a.add(...d);d=pc(e,"underlineStrikethrough");let f=!1,g=b&8&&b&4;var h=c&8&&c&4;void 0!==d&&(h?(f=!0,g||a.add(...d)):g&&a.remove(...d));for(let k in gb)h=gb[k],d=pc(e,k),void 0!==d&&(c&h?!f||"underline"!==k&&"strikethrough"!==k?(0===(b&h)||g&&"underline"===k||"strikethrough"===k)&&a.add(...d):b&h&&a.remove(...d):b&h&&a.remove(...d))}
...
class ne extends ae{static getType(){return"text"}static clone(a){return new ne(a.__text,a.__key)}constructor(a,b){super(b);this.__text=a;this.__format=0;this.__style="";this.__detail=this.__mode=0}getFormat(){return this.getLatest().__format}getDetail(){return this.getLatest().__detail}getMode(){let a=this.getLatest();return ob[a.__mode]}getStyle(){return this.getLatest().__style}isToken(){return 1===this.getLatest().__mode}isComposing(){return this.__key===dc()}isSegmented(){return 2===this.getLatest().__mode}isDirectionless(){return 0!==
...
b.selectStart():b.getParentOrThrow().selectStart()):(b=a[a.length-1],E(b)?b.selectEnd():b.getParentOrThrow().selectEnd()));if(d.anchorNode!==g.startContainer||d.anchorOffset!==g.startOffset)b=this.focus,f=this.anchor,d=f.key,g=f.offset,e=f.type,Oe(f,b.key,b.offset,b.type),Oe(b,d,g,e),this._cachedNodes=null}}}forwardDeletion(a,b,c){return!c&&("element"===a.type&&E(b)&&a.offset===b.getChildrenSize()||"text"===a.type&&a.offset===b.getTextContentSize())&&(a=b.getParent(),b=b.getNextSibling()||(null===
a?null:a.getNextSibling()),E(b)&&b.isShadowRoot())?!0:!1}deleteCharacter(a){let b=this.isCollapsed();if(this.isCollapsed()){var c=this.anchor,d=c.getNode();if(this.forwardDeletion(c,d,a))return;var e=this.focus,f=sc(e,a);if(y(f)&&!f.isIsolated()){f.isKeyboardSelectable()&&E(d)&&0===d.getChildrenSize()?(d.remove(),a=We(),a.add(f.__key),Ab(a)):(f.remove(),F().dispatchCommand(ba,void 0));return}if(!a&&E(f)&&E(d)&&d.isEmpty()){d.remove();f.selectStart();return}this.modify("extend",a,"character");if(!this.isCollapsed()){f=
"text"===e.type?e.getNode():null;d="text"===c.type?c.getNode():null;if(null!==f&&f.isSegmented()){if(c=e.offset,e=f.getTextContentSize(),f.is(d)||a&&c!==e||!a&&0!==c){Xe(f,a,c);return}}else if(null!==d&&d.isSegmented()&&(c=c.offset,e=d.getTextContentSize(),d.is(f)||a&&0!==c||!a&&c!==e)){Xe(d,a,c);return}d=this.anchor;f=this.focus;c=d.getNode();e=f.getNode();if(c===e&&"text"===d.type&&"text"===f.type){var g=d.offset,h=f.offset;let k=g<h;e=k?g:h;h=k?h:g;g=h-1;e!==g&&(c=c.getTextContent().slice(e,h),
jc(c)||(a?f.offset=g:d.offset=g))}}else if(a&&0===c.offset&&("element"===c.type?c.getNode():c.getNode().getParentOrThrow()).collapseAtStart(this))return}this.removeText();a&&!b&&this.isCollapsed()&&"element"===this.anchor.type&&0===this.anchor.offset&&(a=this.anchor.getNode(),a.isEmpty()&&L(a.getParent())&&0===a.getIndexWithinParent()&&a.collapseAtStart(this))}deleteLine(a){this.isCollapsed()&&("text"===this.anchor.type&&this.modify("extend",a,"lineboundary"),0===(a?this.focus:this.anchor).offset&&
this.modify("extend",a,"character"));this.removeText()}deleteWord(a){if(this.isCollapsed()){let b=this.anchor,c=b.getNode();if(this.forwardDeletion(b,c,a))return;this.modify("extend",a,"word")}this.removeText()}isBackward(){return this.focus.isBefore(this.anchor)}getStartEndPoints(){return[this.anchor,this.focus]}}function Td(a){return a instanceof Pe}function Ye(a){let b=a.offset;if("text"===a.type)return b;a=a.getNode();return b===a.getChildrenSize()?a.getTextContent().length:0}
function Re(a){a=a.getStartEndPoints();if(null===a)return[0,0];let [b,c]=a;return"element"===b.type&&"element"===c.type&&b.key===c.key&&b.offset===c.offset?[0,0]:[Ye(b),Ye(c)]}function Xe(a,b,c){let d=a.getTextContent().split(/(?=\s)/g),e=d.length,f=0,g=0;for(let h=0;h<e;h++){let k=d[h],m=h===e-1;g=f;f+=k.length;if(b&&f===c||f>c||m){d.splice(h,1);m&&(g=void 0);break}}b=d.join("").trim();""===b?a.remove():(a.setTextContent(b),a.select(g,g))}
...
function mf(a,b){let c=a._pendingEditorState,d=a._rootElement,e=a._headless||null===d;if(null!==c){var f=a._editorState,g=f._selection,h=c._selection,k=0!==a._dirtyType,m=S,q=U,p=T,l=a._updating,r=a._observer,w=null;a._pendingEditorState=null;a._editorState=c;if(!e&&k&&null!==r){T=a;S=c;U=!1;a._updating=!0;try{let D=a._dirtyType,P=a._dirtyElements,Q=a._dirtyLeaves;r.disconnect();var A=D,x=P,z=Q;N=Jc=M="";Mc=2===A;Pc=null;O=a;Kc=a._config;Lc=a._nodes;Oc=O._listeners.mutation;Qc=x;$c=z;ad=f._nodeMap;
bd=c._nodeMap;Nc=c._readOnly;cd=new Map(a._keyToDOMMap);let ha=new Map;dd=ha;rd("root",null);dd=cd=Kc=bd=ad=$c=Qc=Lc=O=void 0;w=ha}catch(D){D instanceof Error&&a._onError(D);if(ef)throw D;nf(a,null,d,c);Db(a);a._dirtyType=2;ef=!0;mf(a,f);ef=!1;return}finally{r.observe(d,ff),a._updating=l,S=m,U=q,T=p}}c._readOnly||(c._readOnly=!0);var aa=a._dirtyLeaves,W=a._dirtyElements,Ua=a._normalizedNodes,ja=a._updateTags,Rc=a._deferred;k&&(a._dirtyType=0,a._cloneNotNeeded.clear(),a._dirtyLeaves=new Set,a._dirtyElements=
new Map,a._normalizedNodes=new Set,a._updateTags=new Set);var xe=a._decorators,Mb=a._pendingDecorators||xe,zf=c._nodeMap,Sc;for(Sc in Mb)zf.has(Sc)||(Mb===xe&&(Mb=fc(a)),delete Mb[Sc]);var ia=e?null:xb(a._window);if(a._editable&&null!==ia&&(k||null===h||h.dirty)){T=a;S=c;try{null!==r&&r.disconnect();if(k||null===h||h.dirty){let D=a._blockCursorElement;null!==D&&Cc(D,a,d);a:{let P=ia.anchorNode,Q=ia.focusNode,ha=ia.anchorOffset,hb=ia.focusOffset,X=document.activeElement;if(!(ja.has("collaboration")&&
X!==d||null!==X&&Sb(X)))if(C(h)){var ib=h.anchor,Tc=h.focus,ye=ib.key,Af=Tc.key,ze=uc(a,ye),Ae=uc(a,Af),Nb=ib.offset,Be=Tc.offset,Uc=h.format,Vc=h.style,Ce=h.isCollapsed(),jb=ze,Ob=Ae,Wc=!1;if("text"===ib.type){jb=Xb(ze);let Y=ib.getNode();Wc=Y.getFormat()!==Uc||Y.getStyle()!==Vc}else C(g)&&"text"===g.anchor.type&&(Wc=!0);"text"===Tc.type&&(Ob=Xb(Ae));if(null!==jb&&null!==Ob){if(Ce&&(null===g||Wc||C(g)&&(g.format!==Uc||g.style!==Vc))){var Bf=performance.now();Ld=[Uc,Vc,Nb,ye,Bf]}if(ha===Nb&&hb===
Be&&P===jb&&Q===Ob&&("Range"!==ia.type||!Ce)&&(null!==X&&d.contains(X)||d.focus({preventScroll:!0}),"element"!==ib.type))break a;try{ia.setBaseAndExtent(jb,Nb,Ob,Be)}catch(Y){}if(!ja.has("skip-scroll-into-view")&&h.isCollapsed()&&null!==d&&d===document.activeElement){let Y=h instanceof Qe&&"element"===h.anchor.type?jb.childNodes[Nb]||null:0<ia.rangeCount?ia.getRangeAt(0):null;if(null!==Y){let Z;if(Y instanceof Text){let V=document.createRange();V.selectNode(Y);Z=V.getBoundingClientRect()}else Z=Y.getBoundingClientRect();
let xa=d.ownerDocument,Ea=xa.defaultView;if(null!==Ea)for(var {top:Xc,bottom:Yc}=Z,Pb,Qb,na=d;null!==na;){let V=na===xa.body;if(V)Pb=0,Qb=Eb(a).innerHeight;else{let Rb=na.getBoundingClientRect();Pb=Rb.top;Qb=Rb.bottom}let Fa=0;Xc<Pb?Fa=-(Pb-Xc):Yc>Qb&&(Fa=Yc-Qb);if(0!==Fa)if(V)Ea.scrollBy(0,Fa);else{let Rb=na.scrollTop;na.scrollTop+=Fa;let De=na.scrollTop-Rb;Xc-=De;Yc-=De}if(V)break;na=Vb(na)}}}Hd=!0}}else null!==g&&Tb(a,P,Q)&&ia.removeAllRanges()}}a:{let D=a._blockCursorElement;if(C(h)&&h.isCollapsed()&&
"element"===h.anchor.type&&d.contains(document.activeElement)){let P=h.anchor,Q=P.getNode(),ha=P.offset,hb=Q.getChildrenSize(),X=!1,Y=null;if(ha===hb){let Z=Q.getChildAtIndex(ha-1);Bc(Z)&&(X=!0)}else{let Z=Q.getChildAtIndex(ha);if(Bc(Z)){let xa=Z.getPreviousSibling();if(null===xa||Bc(xa))X=!0,Y=a.getElementByKey(Z.__key)}}if(X){let Z=a.getElementByKey(Q.__key);if(null===D){let xa=a._config.theme,Ea=document.createElement("div");Ea.contentEditable="false";Ea.setAttribute("data-lexical-cursor","true");
let V=xa.blockCursor;if(void 0!==V){if("string"===typeof V){let Fa=pb(V);V=xa.blockCursor=Fa}void 0!==V&&Ea.classList.add(...V)}a._blockCursorElement=D=Ea}d.style.caretColor="transparent";null===Y?Z.appendChild(D):Z.insertBefore(D,Y);break a}}null!==D&&Cc(D,a,d)}null!==r&&r.observe(d,ff)}finally{T=p,S=m}}if(null!==w){var Cf=w;let D=Array.from(a._listeners.mutation),P=D.length;for(let Q=0;Q<P;Q++){let [ha,hb]=D[Q],X=Cf.get(hb);void 0!==X&&ha(X,{dirtyLeaves:aa,prevEditorState:f,updateTags:ja})}}C(h)||
null===h||null!==g&&g.is(h)||a.dispatchCommand(ba,void 0);var Zc=a._pendingDecorators;null!==Zc&&(a._decorators=Zc,a._pendingDecorators=null,of("decorator",a,!0,Zc));var Df=gc(b||f),Ee=gc(c);Df!==Ee&&of("textcontent",a,!0,Ee);of("update",a,!0,{dirtyElements:W,dirtyLeaves:aa,editorState:c,normalizedNodes:Ua,prevEditorState:b||f,tags:ja});a._deferred=[];if(0!==Rc.length){let D=a._updating;a._updating=!0;try{for(let P=0;P<Rc.length;P++)Rc[P]()}finally{a._updating=D}}var Fe=a._updates;if(0!==Fe.length){let D=
Fe.shift();if(D){let [P,Q]=D;pf(a,P,Q)}}}}function of(a,b,c,...d){let e=b._updating;b._updating=c;try{let f=Array.from(b._listeners[a]);for(a=0;a<f.length;a++)f[a].apply(null,d)}finally{b._updating=e}}
...
b=this.getChildren(),c=b.length;for(let d=0;d<c;d++){let e=b[d];a+=e.getTextContentSize();E(e)&&d!==c-1&&!e.isInline()&&(a+=2)}return a}getDirection(){return this.getLatest().__dir}hasFormat(a){return""!==a?(a=lb[a],0!==(this.getFormat()&a)):!1}select(a,b){G();let c=u(),d=a,e=b;var f=this.getChildrenSize();if(!this.canBeEmpty())if(0===a&&0===b){if(a=this.getFirstChild(),B(a)||E(a))return a.select(0,0)}else if(!(void 0!==a&&a!==f||void 0!==b&&b!==f)&&(a=this.getLastChild(),B(a)||E(a)))return a.select();
void 0===d&&(d=f);void 0===e&&(e=f);f=this.__key;if(C(c))c.anchor.set(f,d,"element"),c.focus.set(f,e,"element"),c.dirty=!0;else return se(f,d,f,e,"element","element");return c}selectStart(){let a=this.getFirstDescendant();return a?a.selectStart():this.select()}selectEnd(){let a=this.getLastDescendant();return a?a.selectEnd():this.select()}clear(){let a=this.getWritable();this.getChildren().forEach(b=>b.remove());return a}append(...a){return this.splice(this.getChildrenSize(),0,a)}setDirection(a){let b=
this.getWritable();b.__dir=a;return b}setFormat(a){this.getWritable().__format=""!==a?lb[a]:0;return this}setIndent(a){this.getWritable().__indent=a;return this}splice(a,b,c){let d=c.length,e=this.getChildrenSize(),f=this.getWritable(),g=f.__key;var h=[],k=[];let m=this.getChildAtIndex(a+b),q=null,p=e-b+d;if(0!==a)if(a===e)q=this.getLastChild();else{var l=this.getChildAtIndex(a);null!==l&&(q=l.getPreviousSibling())}if(0<b){var r=null===q?this.getFirstChild():q.getNextSibling();for(l=0;l<b;l++){null===
r&&n(100);var w=r.getNextSibling(),A=r.__key;r=r.getWritable();bc(r);k.push(A);r=w}}l=q;for(w=0;w<d;w++){A=c[w];null!==l&&A.is(l)&&(q=l=l.getPreviousSibling());r=A.getWritable();r.__parent===g&&p--;bc(r);let x=A.__key;null===l?(f.__first=x,r.__prev=null):(l=l.getWritable(),l.__next=x,r.__prev=l.__key);A.__key===g&&n(76);r.__parent=g;h.push(x);l=A}a+b===e?null!==l&&(l.getWritable().__next=null,f.__last=l.__key):null!==m&&(a=m.getWritable(),null!==l?(b=l.getWritable(),a.__prev=l.__key,b.__next=m.__key):
...
{d.forEach(e=>e.transforms.delete(b))}}hasNode(a){return this._nodes.has(a.getType())}hasNodes(a){return a.every(this.hasNode.bind(this))}dispatchCommand(a,b){return R(this,a,b)}getDecorators(){return this._decorators}getRootElement(){return this._rootElement}getKey(){return this._key}setRootElement(a){let b=this._rootElement;if(a!==b){let f=pc(this._config.theme,"root");var c=this._pendingEditorState||this._editorState;this._rootElement=a;nf(this,b,a,c);if(null!==b){if(!this._config.disableEvents){var d=
b.ownerDocument,e=Gd.get(d);if(void 0===e)throw Error("Root element not registered");Gd.set(d,e-1);1===e&&d.removeEventListener("selectionchange",Wd);d=b.__lexicalEditor;null!==d&&void 0!==d&&(null!==d._parentEditor?(e=kc(d),e=e[e.length-1]._key,Vd.get(e)===d&&Vd.delete(e)):Vd.delete(d._key),b.__lexicalEditor=null);d=Ud(b);for(e=0;e<d.length;e++)d[e]();b.__lexicalEventHandles=[]}null!=f&&b.classList.remove(...f)}null!==a?(c=(c=a.ownerDocument)&&c.defaultView||null,d=a.style,d.userSelect="text",d.whiteSpace=
"pre-wrap",d.wordBreak="break-word",a.setAttribute("data-lexical-editor","true"),this._window=c,this._dirtyType=2,Db(this),this._updateTags.add("history-merge"),mf(this),this._config.disableEvents||Xd(a,this),null!=f&&a.classList.add(...f)):(this._editorState=c,this._window=this._pendingEditorState=null);of("root",this,!1,a,b)}}getElementByKey(a){return this._keyToDOMMap.get(a)||null}getEditorState(){return this._editorState}setEditorState(a,b){a.isEmpty()&&n(38);Cb(this);let c=this._pendingEditorState,
d=this._updateTags;b=void 0!==b?b.tag:null;null===c||c.isEmpty()||(null!=b&&d.add(b),mf(this));this._pendingEditorState=a;this._dirtyType=2;this._dirtyElements.set("root",!1);this._compositionKey=null;null!=b&&d.add(b);mf(this)}parseEditorState(a,b){a="string"===typeof a?JSON.parse(a):a;let c=xf(),d=S,e=U,f=T,g=this._dirtyElements,h=this._dirtyLeaves,k=this._cloneNotNeeded,m=this._dirtyType;this._dirtyElements=new Map;this._dirtyLeaves=new Set;this._cloneNotNeeded=new Set;this._dirtyType=0;S=c;U=
!1;T=this;try{kf(a.root,this._nodes),b&&b(),c._readOnly=!0}catch(q){q instanceof Error&&this._onError(q)}finally{this._dirtyElements=g,this._dirtyLeaves=h,this._cloneNotNeeded=k,this._dirtyType=m,S=d,U=e,T=f}return c}update(a,b){v(this,a,b)}focus(a,b={}){let c=this._rootElement;null!==c&&(c.setAttribute("autocapitalize","off"),v(this,()=>{let d=u(),e=J();null!==d?d.dirty=!0:0!==e.getChildrenSize()&&("rootStart"===b.defaultSelection?e.selectStart():e.selectEnd())},{onUpdate:()=>{c.removeAttribute("autocapitalize");
a&&a()},tag:"focus"}),null===this._pendingEditorState&&c.removeAttribute("autocapitalize"))}blur(){var a=this._rootElement;null!==a&&a.blur();a=xb(this._window);null!==a&&a.removeAllRanges()}isEditable(){return this._editable}setEditable(a){this._editable!==a&&(this._editable=a,of("editable",this,!0,a))}toJSON(){return{editorState:this._editorState.toJSON()}}}exports.$addUpdateTag=function(a){G();F()._updateTags.add(a)};exports.$applyNodeReplacement=zc;exports.$copyNode=yc;
exports.$createLineBreakNode=he;exports.$createNodeSelection=We;exports.$createParagraphNode=ce;exports.$createPoint=Le;exports.$createRangeSelection=function(){let a=Le("root",0,"element"),b=Le("root",0,"element");return new Qe(a,b,0,"")};exports.$createTabNode=ve;exports.$createTextNode=K;exports.$getAdjacentNode=sc;exports.$getCharacterOffsets=Re;exports.$getEditor=function(){return F()};exports.$getNearestNodeFromDOMNode=wb;exports.$getNearestRootOrShadowRoot=wc;exports.$getNodeByKey=I;
exports.$getPreviousSelection=nc;exports.$getRoot=J;exports.$getSelection=u;exports.$getTextContent=function(){let a=u();return null===a?"":a.getTextContent()};exports.$hasAncestor=vc;exports.$hasUpdateTag=function(a){return F()._updateTags.has(a)};exports.$insertNodes=function(a){let b=u()||nc();null===b&&(b=J().selectEnd());b.insertNodes(a)};exports.$isBlockElementNode=function(a){return E(a)&&!a.isInline()};exports.$isDecoratorNode=y;exports.$isElementNode=E;
exports.$isInlineElementOrDecoratorNode=function(a){return E(a)&&a.isInline()||y(a)&&a.isInline()};exports.$isLeafNode=function(a){return B(a)||Fc(a)||y(a)};exports.$isLineBreakNode=Fc;exports.$isNodeSelection=Td;exports.$isParagraphNode=function(a){return a instanceof Ef};exports.$isRangeSelection=C;exports.$isRootNode=L;exports.$isRootOrShadowRoot=xc;exports.$isTabNode=Je;exports.$isTextNode=B;
exports.$nodesOfType=function(a){var b=ac();let c=b._readOnly,d=a.getType();b=b._nodeMap;let e=[];for(let [,f]of b)f instanceof a&&f.__type===d&&(c||f.isAttached())&&e.push(f);return e};exports.$normalizeSelection__EXPERIMENTAL=Ib;exports.$parseSerializedNode=function(a){return kf(a,F()._nodes)};exports.$selectAll=function(){var a=J();a=a.select(0,a.getChildrenSize());Ab(Ib(a))};exports.$setCompositionKey=H;exports.$setSelection=Ab;
